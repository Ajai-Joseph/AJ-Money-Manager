...
class ExpenseMonthlyList extends StatefulWidget {
  final String date;
  
  const ExpenseMonthlyList({
    super.key,
    required this.date,
  });

  @override
  State<ExpenseMonthlyList> createState() => _ExpenseMonthlyListState();
}

class _ExpenseMonthlyListState extends State<ExpenseMonthlyList>
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, List<CategoryModel> expenseList, Widget? child) {
        ...
        final filteredList = expenseList
        ...
        if (filteredList.isEmpty) {
          return const EmptyState(
            ...
            message: 'No expense transactions found for this month.',
          );
        }
